...
register_block_pattern(
    'dahlia/post-layout',
    array(
        'title'       => __('Page Cover', 'dahlia'),
        'description' => __('A customizable page cover with featured image, title, paragraph and buttons.', 'dahlia'),
        'categories'  => array('dahlia-patterns'),
        'content'     => '
...
<!-- /wp:group -->
        ',
        'keywords'    => array('post', 'layout', 'featured'),
        'viewport_width' => 1200,
    )
);
